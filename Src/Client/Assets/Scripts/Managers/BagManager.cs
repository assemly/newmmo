...
namespace Managers
{
    class BagManager:Singleton<BagManager>
    {
        ...
        public void AddItem(int itemId, int count)
        {
            ...
            //ushort temp = addCount;
            //while (addCount < DataManager.Instance.Items[itemId].StackLimit)
            //{
            //    for (int i = 0; i < Items.Length; i++)
            //    {
            //        if (this.Items[i].ItemId == 0)
            //        {
            //            if(addCount <= DataManager.Instance.Items[itemId].StackLimit)
            //            {
